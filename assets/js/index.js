...
$(document).ready(function() {
  ...
  $(window).load(function() {
    ...
    insertResponseMessage('I am your personal AI for travel guidance. How can I help you?');
  });
  ...
  function insertMessage() {
    new_message = $('.message-input').val();
    if ($.trim(new_message) == '') {
      return false;
    }
    $('<div class="message message-personal">' + new_message + '</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    $('.message-input').val(null);
    updateScrollbar();

      retrieveInfo(new_message)
      .then((response) => {
